...
module.exports = {
	...
	theme: {
		...
		animation: {
			...
			modalDialog: "opacityMenuShow .2s linear",
			fade: "fade .5s linear",
			progressSwiperNews: "progressSwiperNews 4s linear forwards",
		},
		...
		boxShadow: {
			...
			dropdownAbsolute: "rgba(17, 17, 26, 0.1) 0px 4px 16px, rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px",
